...
RSpec.describe "/areas", type: :request do
  ...
  # AreasController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get areas_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Area" do
        expect {
          post areas_url,
               params: { area: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Area" do
        expect {
          post areas_url,
               params: { area: invalid_attributes }, as: :json
        }.to change(Area, :count).by(0)
      end

      it "renders a JSON response with errors for the new area" do
        post areas_url,
             params: { area: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested area" do
        area = Area.create! valid_attributes
        patch area_url(area),
              params: { area: new_attributes }, headers: valid_headers, as: :json
        area.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested area" do
      area = Area.create! valid_attributes
      expect {
        delete area_url(area), headers: valid_headers, as: :json
      }.to change(Area, :count).by(-1)
    end
  end
end
